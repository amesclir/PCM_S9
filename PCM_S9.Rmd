...
1. Ajusta todos los modelos birth-death, birth-death con tasas que varían exponencialmente y birth-death con tasas que varían en función del número de especies pero con el árbol "Anolis.tre" (asumiendo un muestreo completo en la filogenia).
...
1. Corre el software bamm pero para estudiar la evolución del tamaño de la ballenas y delfines en la filogenia con un modelo browniano con múltiples tasas y búsqueda rjMCMC (usa para ellos los archivos disponibles en este proyecto de R -traitcontrol.txt , whale_size.txt y whaletree.tre-).
